...
export default function Dashboard() {
  ...
  const InvestmentRow = ({ investment }: { investment: any }) => {
      ...
      <TableRow>
        ...
        <TableCell>
          <Badge 
            variant="outline" 
            className={`text-xs ${
              investment.project?.status === 'active' ? 'border-green-500 text-green-600' :
    ...
    <div className="container-xl py-8 space-y-8">
      ...
      >
        <StatCard
          ...
          value={formatCurrency(portfolioMetrics.currentBalance)}
          icon={Wallet}
        />
        <StatCard
          title="Total investi"
        ...
        <StatCard
          ...
          value={portfolioMetrics.investmentCount.toString()}
          icon={Target}
        />
      </motion.div>
                    ...
                    {investmentsLoading ? (
                      ...
                      <div className="space-y-3">
                        {investments.slice(0, 5).map((investment) => (
                          <div key={investment.id} className="flex items-center justify-between p-3 hover:bg-muted/50 rounded-lg transition-colors">
                            <div className="flex items-center space-x-3">
                              <div className="w-8 h-8 bg-muted rounded-md flex items-center justify-center">
                                <span className="text-xs font-medium">
                                  {investment.project?.title?.[0]}
                            ...
                            <div className="text-right">
                              ...
                              <Badge 
                                variant={
                                  calculateROI(parseFloat(investment.currentValue), parseFloat(investment.amount)) >= 0 
                                    ? 'default' 
                                    : 'destructive'
                                }
                                className="text-xs"
